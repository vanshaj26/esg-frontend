    ...
    <div class="col-md-12">
      <card>
        ...
        <tabs type="primary" >
          ...
          <tab-pane label="Social">
           <!-- <add-general-data/> -->
          </tab-pane>

           <tab-pane label="Governance">
           <!-- <add-general-data/> -->
          </tab-pane>
...
import AddGeneralData from "../Data/AddGeneralData.vue"

let datastatus = [0,,1,2,3,4]
